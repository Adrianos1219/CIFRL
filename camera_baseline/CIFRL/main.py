...
def run_CIFRL(val_sbjs, cfg, ckpt_folder, ckpt_freq, resume, rng_generator, run):
    ...
    print("Number of learnable parameters for CIFRL: {}".format(sum(p.numel() for p in model.parameters() if p.requires_grad)))
    # optimizer
