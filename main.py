...
from camera_baseline.CIFRL.main import run_CIFRL
...
def main(args):
    ...
    for i, anno_split in enumerate(config['anno_json']):
        ...
        t_losses, v_losses, v_mAP, v_preds, v_gt = run_CIFRL(val_sbjs, config, log_dir, args.ckpt_freq, args.resume, rng_generator, run)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/60_frames_30_stride/CIFRL_combined.yaml')
